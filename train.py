...
from models.common import Weight_Concat3,Weight_Concat4
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    for v in model.modules():
        ...
        if isinstance(v, nn.BatchNorm2d):  # weight (no decay)
            ...
            g1.append(v.weight)
        elif isinstance(v, Weight_Concat3) and hasattr(v, 'w') and isinstance(v.w, nn.Parameter):
            g1.append(v.w)
        elif isinstance(v, Weight_Concat4) and hasattr(v, 'w') and isinstance(v.w, nn.Parameter):
            g1.append(v.w)
